...
package org.apache.flink.streaming.examples.multiple;
...
public class SocketMultiple {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<String> multiple =
                input.map(
                        new MapFunction<String, String>() {
                            @Override
                            public String map(String value) throws Exception {
                                int multiple = Integer.parseInt(value) * 2;
                                return Integer.toString(multiple);
                            }
                        });

        multiple.addSink(new PrintSinkFunction<>()).setParallelism(1);
